...
<!-- AlliedMTL/home-3.html  29 Nov 2019 03:36:45 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">

    <title>Allied Material Testing Laboratories - Home</title>
    ...
    <!-- Color CSS -->
    <link rel="alternate stylesheet" href="css/color-blue.css" title="color-blue">
    <link rel="alternate stylesheet" href="css/color-dark-blue.css" title="color-dark-blue">
    <link rel="alternate stylesheet" href="css/color-orange.css" title="color-orange">
    <link rel="alternate stylesheet" href="css/color-pink.css" title="color-pink">
    <link rel="alternate stylesheet" href="css/color-red.css" title="color-red">
    <link rel="stylesheet" href="css/color-green.css" title="color-green">
...
<body class="home-three">
    ...
    <?php include 'includes/header.php'; ?>
        ...
        <!-- Hereo Section -->
    <section id="innar-hero" class="p-100">
        <div class="container text-center">
            <h2 class="color-white mb-0">Equipments, Machines & Apparatus</h2>
        </div>
    </section>
    <!-- End of Hero Section -->
    
    <!-- Event Section -->
    <section id="events" class="p-150 single-blog" style="margin-top:-7%">
        <div class="container">
            <div class="row">
                <div class="col-md-12 single-page-content">
                    <div class="row blog-single-wrap">
                        <div class="col-md-12 pl-0 mt-4">
                            <center>
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="img/blog/sb-2.jpg" alt="AlliedMTL" class="img-fluid"><br>Carbon Fiber Machine
                                </div>
                                <div class="col-md-4">
                                    <img src="img/blog/sb-3.jpg" alt="AlliedMTL" class="img-fluid">
                                    <br>Compression Machine
                                </div> <div class="col-md-4">
                                    <img src="img/blog/sb-4.jpg" alt="AlliedMTL" class="img-fluid">
                                    <br>Sieve Sets, Moisture Can, Glass Plate & Liquid Limit Device
                                </div>
                            </div>
                                <br>
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="img/blog/sb-5.jpg" alt="AlliedMTL" class="img-fluid"><br>Mixing Bowl, Grooving Tools, Spatula & Slumb Test Cone
                                </div>
                                <div class="col-md-4">
                                    <img src="img/blog/sb-6.jpg" alt="AlliedMTL" class="img-fluid">
                                    <br>Weighing Scales & Field Tin Cans
                                </div> <div class="col-md-4">
                                    <img src="img/blog/sb-7.jpg" alt="AlliedMTL" class="img-fluid">
                                    <br>Straight Edge and Rubber Mallet, and Calibrated Sand
                                </div>
                            </div>
                                <br>
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="img/blog/sb-8.jpg" alt="AlliedMTL" class="img-fluid"><br>Mixing Bowl, Grooving Tools, Spatula & Slumb Test Cone
                                </div>
                                <div class="col-md-4">
                                    <img src="img/blog/sb-9.jpg" alt="AlliedMTL" class="img-fluid">
                                    <br>Weighing Scales & Field Tin Cans
                                </div> <div class="col-md-4">
                                    <img src="img/blog/sb-7.jpg" alt="AlliedMTL" class="img-fluid">
                                    <br>Straight Edge and Rubber Mallet, and Calibrated Sand
...
<!-- AlliedMTL/home-3.html  29 Nov 2019 03:37:12 GMT -->
</html>